...
def get_args():
    parser = argparse.ArgumentParser(description="This program locates reverse palindromes in a DNA sequence and returns their left most position in the sequence and length.")
